...
<div class="section">
    ...
    <div class="title">
   <textarea name="title" id="title" placeholder="제목을 입력해주세요" cols="100" rows="0"></textarea>

    </div>
    <div class="writer">
        <textarea name="writer" placeholder="아이디를 입력해주세요" id="writer" cols="30" rows="0"></textarea>
